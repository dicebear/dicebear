...
export const previewRowSeeds: Record<string, string[]> = {
  ...
  cameo: ['Dion', 'Isabel', 'Casper', 'Elba', 'Ben', 'Edith', 'Arlo', 'Rowan'],
  cats: ['Dora', 'Ilan', 'Calla', 'Eden', 'Bodhi', 'Eva', 'Andre', 'Rowan'],
  ...
  marbles: ['Diana', 'Ilaria', 'Cora', 'Eli', 'Boris', 'Ethan', 'Alma', 'Ronan'],
...
export const styleCardSeeds: Record<string, string[]> = {
  ...
  cameo: ['Devon', 'Ivy', 'Calla', 'Ewan'],
  cats: ['Dita', 'Iona', 'Cai', 'Erik'],
  ...
  marbles: ['Denver', 'Iva', 'Curtis', 'Ella'],
...
export const ogTileSeeds: Record<string, string[]> = {
  ...
  cameo: ['Ravi', 'Brea', 'Ilias', 'Ayla', 'Reza'],
  cats: ['Dahlia', 'Brenda', 'Cosima', 'Roshan', 'Cecile'],
  ...
  marbles: ['Callum', 'Ari', 'Dora', 'Ines', 'Bodhi'],
