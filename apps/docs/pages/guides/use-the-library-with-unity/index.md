...
[HTTP API](/how-to-use/http-api/) returns finished PNGs that
`UnityWebRequestTexture` loads into a texture, and the
[C# library](/how-to-use/csharp-library/) generates the SVG inside the game.
...
and the [HTTP API reference](/how-to-use/http-api/) has the full list. If you
would rather not depend on our servers, you can
[host the API yourself](/guides/host-the-http-api-yourself/).
...
[C# library reference](/how-to-use/csharp-library/).
