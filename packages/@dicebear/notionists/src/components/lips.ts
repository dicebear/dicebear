...
export const lips: ComponentGroup = {
  variant30: (
  ...
  variant01: (
    ...
    `<path d="M185.6 59.2c7.2 8.7 9.1 20 20.2 25 4.5 2 2.4 7.7-2.9 9.1a31 31 0 0 1-10.1.5c-22.4-1.6-44.7-3.4-67.2.5-7.7 1.3-16-.3-24-.7-4.3-.2-7.5-2.4-8-6.8s3.5-6.4 6.5-6.5c13.7-.4 21-10.2 28.8-19 6.8-8 15-9.4 24.8-9.5 11.1-.2 22.7-4 32 7.4ZM170.2 119.5c-10 1.2-19.5 3.4-28-6.2 9.4-4.8 17.9-4.2 26-4.8 3-.2 6.9 1.9 7.6 5.7.5 2.9-2.3 4.1-5.6 5.3Z" fill="#000"/>`,
};
