...
export const nose: ComponentGroup = {
  ...
  variant09: (
    ...
    `<g fill="#000"><path d="M75.1 117.2c3.9 16.3 7.4 31.6 11.2 46.7 5 19.6 2.1 28.4-15.7 35.9-20 8.2-45.5 7-59.6-15.5-2.2-3.5-3.6-6.6-3-10.6.7-3.2 1.9-5.7 5.4-6.3 3.7-.6 5 1.5 6.4 4.6 9.4 19.7 23.7 25.2 43.7 17.1 10.1-4 13.3-11.8 10-21.6a292 292 0 0 1-13.5-67c-1.5-14.8-4.2-30.2 5.7-43.3h4l5.4 60Z"/><path d="M31.5 177.5c-5.7-8.1 0-10.7 5.5-12.3 4-1.2 8.2 1 7.9 5.6-.5 8-6.1 8.8-13.4 6.7Z"/></g>`,
  variant08: (
    components: ComponentPickCollection,
    colors: ColorPickCollection
  ) =>
