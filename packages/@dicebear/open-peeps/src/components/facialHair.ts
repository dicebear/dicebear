...
`,
  ...
  <g fill-rule="evenodd" clip-rule="evenodd">
    <path d="M245.4 32.8c-14-2.3-28.6 1.2-42.2 4.9-21.4-14.1-49.3.1-64.7 17.7-5.2 4.4-16.3 10.1-10.5 18.4-2.2 5.9-2.8 8.6 1.8 1.8 25.9 3 53.6-2.7 79.2-8 8.8 3 16.4 9.8 26 7.5 9 1.9 19 3.7 27-2.1 6.3-.3 20.2 10.9 20-2.1-2-12.5-26.7-33.2-36.6-38Z" fill="${colors.hair.value}"/>
