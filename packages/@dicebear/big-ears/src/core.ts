...
export const style: Style<Options> = {
  ...
  <g transform="translate(81.7 150.7) scale(.71856)">
    ${components.face?.value(components, colors) ?? ''}
  </g>
  <g transform="translate(199.5 333.4) scale(.71856)">
    ${components.mouth?.value(components, colors) ?? ''}
  </g>
  <g transform="translate(280.7 235.4) scale(.71856)">
    ${components.ear?.value(components, colors) ?? ''}
  </g>
  <g transform="matrix(-.71856 0 0 .71856 161.5 235.4)">
    ${components.ear?.value(components, colors) ?? ''}
  </g>
  <g transform="translate(114.8 215.5) scale(.71856)">
    ${components.eyes?.value(components, colors) ?? ''}
  </g>
  <g transform="translate(127.7 288.7) scale(.71856)">
    ${components.cheek?.value(components, colors) ?? ''}
  </g>
  <g transform="translate(193 279.4) scale(.71856)">
    ${components.nose?.value(components, colors) ?? ''}
  </g>
  <g transform="matrix(.52237 0 0 .52237 122.9 244.8)">
    ${components.sideburn?.value(components, colors) ?? ''}
  </g>
  <g transform="matrix(-.52237 0 0 .52237 315.7 244.8)">
    ${components.sideburn?.value(components, colors) ?? ''}
  </g>
  <g transform="matrix(.52237 0 0 .52237 108.7 145.6)">
