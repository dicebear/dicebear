...
`,
  ...
  <path d="M14 2H6v1H5v1H4v2h14V5h-2V4h-1V3h-1V2Z" fill="${colors.hat.value}"/>
...
`,
  ...
  <path d="M4 0v5H2v1h16V5h-2V0H4Z" fill="${colors.hat.value}"/>
...
`,
  ...
  <path d="M5 4H4v2h14V5h-2V4h-1V3h-1V2H6v1H5v1Z" fill="${colors.hat.value}"/>
