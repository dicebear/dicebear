	...
	export const clothing: ComponentGroup = {
	  ...
	  variant21: (
	    ...
	    `<path d="M5 13H4v3h3v-1H6v-1H5v-1ZM12 13h-1v1h-1v1H9v1h3v-3Z" fill="${escape.xml(
	      `#${colors.clothing}`
	    )}"/><path fill="#fff" fill-opacity=".5" d="M4 13h1v1H4zM5 14h1v1H5zM6 15h1v1H6zM9 15h1v1H9zM10 14h1v1h-1z"/><path fill="#fff" fill-opacity=".3" d="M11 14h1v1h-1z"/><path fill="#fff" fill-opacity=".5" d="M11 13h1v1h-1z"/><path fill="#fff" fill-opacity=".3" d="M10 15h1v1h-1zM5 15h1v1H5zM4 14h1v1H4z"/>`,
	  variant20: (
	    components: ComponentPickCollection,
	    colors: ColorPickCollection
	  ) =>
	    `<path fill="${escape.xml(
	      `#${colors.clothing}`
	    )}" d="M4 14h8v2H4z"/><path fill="#fff" fill-opacity=".3" d="M4 14h1v2H4zM11 14h1v2h-1z"/>`,
	  variant19: (
	    components: ComponentPickCollection,
	    colors: ColorPickCollection
	  ) =>
	  ...
	  variant18: (
	    ...
	    `<path d="M4 13h2v1h1v1h2v-1h1v-1h2v3H4v-3Z" fill="${escape.xml(
	      `#${colors.clothing}`
	    )}"/><path fill="#fff" fill-opacity=".3" d="M10 14h1v1h-1zM11 13h1v1h-1zM9 15h1v1H9z"/><path fill="#fff" fill-opacity=".5" d="M9 14h1v1H9zM10 13h1v1h-1zM8 15h1v1H8z"/><path fill="#fff" fill-opacity=".3" d="M6 14H5v1h1zM5 13H4v1h1zM7 15H6v1h1z"/><path fill="#fff" fill-opacity=".5" d="M7 14H6v1h1zM6 13H5v1h1zM8 15H7v1h1z"/>`,
	  variant17: (
	    components: ComponentPickCollection,
	    colors: ColorPickCollection
	  ) =>
