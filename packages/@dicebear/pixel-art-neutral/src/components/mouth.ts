...
export const mouth: ComponentGroup = {
  sad10: (components: ComponentPickCollection, colors: ColorPickCollection) =>
    `<path d="M7 9v1h1v1h1V9H7Z" fill="${escape.xml(`${colors.mouth}`)}"/>`,
