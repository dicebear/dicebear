...
export const body: ComponentGroup = {
  variant08: (
    ...
    `<g fill="${colors.body.value}"><path d="M12 19a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z"/><path d="M15.33 14H8.67C7.75 14 7 14.45 7 15v7c0 .55.75 1 1.67 1h6.66c.92 0 1.67-.45 1.67-1v-7c0-.55-.75-1-1.67-1Z"/></g>`,
  variant07: (
    components: ComponentPickCollection,
    colors: ColorPickCollection
  ) =>
    `<g fill="${colors.body.value}"><path d="M6 4.2 3 21l9 2 9-2-3-16.8C16.96-.17 7 .02 6 4.2Z"/><path d="M3.5 19a1.5 1.5 0 1 0 0-2.98 1.5 1.5 0 1 0 0 2.99ZM4.5 15.02a1.5 1.5 0 1 0 0-3 1.5 1.5 0 1 0 0 3ZM20.5 19a1.5 1.5 0 1 1 0-2.98 1.5 1.5 0 1 1 0 2.99ZM19.5 15.02a1.5 1.5 0 1 1 0-3 1.5 1.5 0 1 1 0 3Z"/></g>`,
  variant06: (
    components: ComponentPickCollection,
    colors: ColorPickCollection
  ) =>
