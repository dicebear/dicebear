...
export const mouth: ComponentGroup = {
  ...
  variant02: (
    ...
    `<g fill="${colors.mouth.value}"><path d="M7 4.5A5.38 5.38 0 0 0 12 1H2a5.38 5.38 0 0 0 5 3.5Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="m3.09 2 .97 5 .98-5H3.1ZM8.96 2l.98 5 .97-5H8.96Z"/></g>`,
  variant01: (
    components: ComponentPickCollection,
    colors: ColorPickCollection
  ) =>
    `<g fill="${colors.mouth.value}"><path d="M7 0a5.38 5.38 0 0 1 5 3.5H2A5.38 5.38 0 0 1 7 0Z"/><path fill-rule="evenodd" clip-rule="evenodd" d="m3.09 2 .97 5 .98-5H3.1ZM8.96 2l.98 5 .97-5H8.96Z"/></g>`,
};
