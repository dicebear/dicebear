import { escape } from '@dicebear/core';
	...
	export const face: ComponentGroup = {
	  ...
	  square01: (
	    ...
	    `<mask id="faceSquare01-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="130" height="120"><rect width="130" height="120" rx="18" fill="#fff"/></mask><g mask="url(#faceSquare01-a)"><path d="M-2-2h134v124H-2V-2Z" fill="${escape.xml(
	      `#${colors.base}`
	    )}"/><g transform="translate(-1 -1)">${
	      components.texture?.value(components, colors) ?? ''
	    }</g></g>`,
	  square02: (
	    ...
	    `<mask id="faceSquare02-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="130" height="120"><path d="M0 12A12 12 0 0 1 12 0h106a12 12 0 0 1 12 12v70a38 38 0 0 1-38 38H38A38 38 0 0 1 0 82V12Z" fill="#fff"/></mask><g mask="url(#faceSquare02-a)"><path d="M-2-2h134v124H-2V-2Z" fill="${escape.xml(
	      `#${colors.base}`
	    )}"/><g transform="translate(-1 -1)">${
	      components.texture?.value(components, colors) ?? ''
	    }</g></g>`,
