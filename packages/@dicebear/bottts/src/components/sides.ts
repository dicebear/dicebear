...
export const sides: ComponentGroup = {
  'antenna01': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'antenna02': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'cables01': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'cables02': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'squareAssymetric': (components: ComponentPickCollection, colors: ColorPickCollection) => `
