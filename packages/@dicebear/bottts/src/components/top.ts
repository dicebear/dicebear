import { escape } from '@dicebear/core';
	...
	export const top: ComponentGroup = {
	  antenna: (components: ComponentPickCollection, colors: ColorPickCollection) =>
	    `<mask id="topAntenna-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="38" y="5" width="24" height="47"><path d="M52 5h-4v31h-8a2 2 0 0 0-2 2v14h24V38a2 2 0 0 0-2-2h-8V5Z" fill="#E1E6E8"/></mask><g mask="url(#topAntenna-a)"><path d="M0 0h100v52H0V0Z" fill="${escape.xml(
	      `#${colors.base}`
	  ...
	  antennaCrooked: (
	    ...
	    `<mask id="topAntennaCrooked-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="38" y="12" width="24" height="40"><path d="m53.57 39 1.97-4.61-6.19-10.68 2.9-10.63-2.9-.79-3.22 11.84 6.05 10.43-2.1 4.44H38v13h24V39h-8.43Z" fill="#E6E6E6"/></mask><g mask="url(#topAntennaCrooked-a)"><path d="M0 0h100v52H0V0Z" fill="${escape.xml(
	      `#${colors.base}`
	  ...
	  bulb01: (components: ComponentPickCollection, colors: ColorPickCollection) =>
	    `<mask id="topBulb01-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="22" y="0" width="56" height="52"><path d="M48 0a16 16 0 0 0-16 16v16a8 8 0 0 0 8 8H23a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h54a1 1 0 0 0 1-1V41a1 1 0 0 0-1-1H60a8 8 0 0 0 8-8V16A16 16 0 0 0 52 0h-4Z" fill="#59C4FF"/></mask><g mask="url(#topBulb01-a)"><path d="M0 0h100v52H0V0Z" fill="${escape.xml(
	      `#${colors.base}`
	  ...
	  lights: (components: ComponentPickCollection, colors: ColorPickCollection) =>
	    `<mask id="topLights-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="10" y="22" width="80" height="30"><path d="M23 22a5 5 0 0 0-5 5v13h-6a2 2 0 0 0-2 2v10h80V42a2 2 0 0 0-2-2h-6V27a5 5 0 0 0-5-5h-6a5 5 0 0 0-5 5v13h-8V27a5 5 0 0 0-5-5h-6a5 5 0 0 0-5 5v13h-8V27a5 5 0 0 0-5-5h-6Z" fill="#E1E6E8"/></mask><g mask="url(#topLights-a)"><path d="M0 0h100v52H0V0Z" fill="${escape.xml(
	      `#${colors.base}`
	  ...
	  pyramid: (components: ComponentPickCollection, colors: ColorPickCollection) =>
	    `<mask id="topPyramid-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="18" y="8" width="64" height="44"><path fill-rule="evenodd" clip-rule="evenodd" d="m50 8 32 44H18L50 8Z" fill="#fff"/></mask><g mask="url(#topPyramid-a)"><path d="M0 0h100v52H0V0Z" fill="${escape.xml(
	      `#${colors.base}`
