...
`,
  'antennaCrooked': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'glowingBulb01': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'glowingBulb02': (components: ComponentPickCollection, colors: ColorPickCollection) => `
