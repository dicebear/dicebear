...
export const ringThree: ComponentGroup = {
  'eighth': (components: ComponentPickCollection, colors: ColorPickCollection) => `<path d="M28.787 28.787C23.357 34.216 20 41.716 20 50h10a19.937 19.937 0 0 1 5.858-14.142l-7.071-7.071Z" fill="${escape.xml(`${colors.ring}`)}"/>`,
