...
export const mouth: ComponentGroup = {
  'concerned': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'disbelief': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'screamOpen': (components: ComponentPickCollection, colors: ColorPickCollection) => `
