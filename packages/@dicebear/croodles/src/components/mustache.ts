...
`,
  ...
  <path d="M32 22.97c5.981 4.56 20.77 10.944 32.073 0M68.734 22.075c3.024 3.769 17.294 9.03 29.911-1.075" stroke="#000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
`,
  variant01: (
    components: ComponentPickCollection,
    colors: ColorPickCollection
