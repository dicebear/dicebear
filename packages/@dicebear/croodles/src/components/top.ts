...
export const top: ComponentGroup = {
  ...
  variant26: (
    ...
    `<g stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M115.5 53.2A74 74 0 0 0 96.8 100M122.7 52.8c6.3 3.9 20 17 24.5 38.6" stroke="#FFC700"/><path d="M136.8 93.2c-23 2-48.8 11.8-58.8 16.5 0-22.6 19-57 44.7-58.1 25.7-1.3 49.6 19 58.2 41.6-6.8 0-15.3-2.4-44.1 0Z" stroke="${escape.xml(
      colors.top.value
    )}"/><path d="M93.2 103.5c3.5 3.6 11.9 6.6 29 6.6 19 0 48.2-4.2 52.5-6.6 6.7-3.8 6.5-7.4 5.9-10M115.7 52.8c-1.2-3.5-3-10.6-1-11.6 2.7-1.2 9 2.4 8.7 10" stroke="${escape.xml(
      colors.top.value
    )}"/></g>`,
  variant25: (
    components: ComponentPickCollection,
