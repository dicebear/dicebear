...
export const center: ComponentGroup = {
  'shape1Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape2Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape3Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape4Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape5Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape6Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'shape7Inverted': (components: ComponentPickCollection, colors: ColorPickCollection) => `
