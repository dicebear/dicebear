...
const data = [
  [style, { seed: 'test' }, 'centerModifier'],
  [style, { seed: 'test' }, 'cornersModifier'],
  [style, { seed: 'test' }, 'sidesModifier'],
  [style, { seed: 'test' }, 'sidesWrapper'],
  [style, { seed: 'test' }, 'sides'],
  [style, { seed: 'test' }, 'cornersWrapper'],
  [style, { seed: 'test' }, 'corners'],
  [style, { seed: 'test' }, 'centerWrapper'],
  [style, { seed: 'test' }, 'center'],
