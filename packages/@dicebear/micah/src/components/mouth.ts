...
export const mouth: ComponentGroup = {
  'surprised': (components: ComponentPickCollection, colors: ColorPickCollection) => `
...
`,
  'laughing': (components: ComponentPickCollection, colors: ColorPickCollection) => `
  <path d="M62.807 25.177a34 34 0 0 0 1.113-11.846c-.17-2.068-2.284-3.22-4.075-2.513-4.229 1.666-18.218 6.965-28.082 8.322-10.823 1.49-27.213-.319-31.957-.908-1.93-.24-3.649 1.418-3.316 3.433a34 34 0 0 0 66.317 3.512Z" fill="${colors.mouth.value}" stroke="${colors.mouth.value}" stroke-width="4"/>
...
`,
  ...
  <rect x="-6.752" y="17.471" width="70" height="24" rx="4" transform="rotate(-4 -6.752 17.47)" fill="${colors.mouth.value}"/>
...
`,
  ...
  <path d="M-5 41c3.21-7.957 15.107-24.767 37.007-28.348 21.9-3.58 33.12 8.455 35.993 14.92" stroke="${colors.mouth.value}" stroke-width="4"/>
`,
