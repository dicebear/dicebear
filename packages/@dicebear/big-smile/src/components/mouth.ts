...
`,
  ...
  <mask id="mouthOpenSad-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="281" y="343" width="169" height="110">
    <path d="M311.4 362.3c27.7-16.4 51.3-17.4 68-18.4 33.4-2 61.2 8.8 68.6 42.6 6.8 31.1-16.9 49.3-27.8 49-11-.3-13.3-12.3-39.4-12.9-26-.6-63.4 42.9-85.6 26.6-22.2-16.3-18.4-66.5 16.2-87Z" fill="#873C41"/>
  </mask>
  <g mask="url(#mouthOpenSad-a)">
    <path d="M430.6 428.3c-26.2-16.8-55.9-23.5-85.4-26.8-25.3-2.9-53.1-2.7-76.2 8.5 15.5 22.2 11.9 47.5 36.5 52 38 7 102-7.5 131.2-29.4-2-1.4-4-3-6.1-4.3Z" fill="#EE7E8B"/>
    <path d="M299.1 377a46.8 46.8 0 0 0 34.3-8.5c2-1.2 4.2-.1 5.5 1.6 13.2 18.4 47.2 17.5 57-1.4.8-1.5 2.8-2.6 4.4-1.9a29 29 0 0 0 32.3-7.3c10.5-12.5 2.5-33-6.8-46-10.4 8.3-17 27.7-19.8 27.3 0 0-95.4-14.5-130.2 17.7a32.4 32.4 0 0 0 23.3 18.4Z" fill="#fff"/>
  </g>
`,
  teethSmile: (
    components: ComponentPickCollection,
  ...
  <g mask="url(#mouthTeethSmile-a)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="m257.6 434 40-101.1 5.6 2.2-40 101.1-5.6-2.2Zm82.3 32.7 27.7-106.1 5.8 1.5-27.7 106.1-5.8-1.5Zm82.4-25.6L407 363.3l6-1.2 15.2 77.8-5.9 1.2Z" fill="#D1D3D4"/>
  </g>
`,
  awkwardSmile: (
    components: ComponentPickCollection,
  ...
  <g mask="url(#mouthAwkwardSmile-a)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="m285.8 450 17.5-107.4 5.9 1L291.7 451l-5.9-1Zm77.4 14.3 4.3-109.6 6 .2-4.3 109.6-6-.2Zm66.8-29.8L416.4 348l6-1 13.6 86.4-6 1Z" fill="#D1D3D4"/>
  </g>
`,
  braces: (
    components: ComponentPickCollection,
