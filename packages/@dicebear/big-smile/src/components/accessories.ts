...
export const accessories: ComponentGroup = {
  ...
  <path d="M192.2 102.9c11.2-17.1 55.8 14.7 77.3 33-29.2-1.8-45.2 37.3-50.4 56.4-9.2 9-24.5 10.7-30.7 10.7-3.4-26.3-7.3-83 3.8-100.1Z" fill="#A09B9B"/>
  <mask id="accessoriesCatEars-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="184" y="97" width="86" height="106">
    <path d="M192.2 102.9c11.2-17.1 55.8 14.7 77.3 33-29.2-1.8-45.2 37.3-50.4 56.4-9.2 9-24.5 10.7-30.7 10.7-3.4-26.3-7.3-83 3.8-100.1Z" fill="#A09B9B"/>
  </mask>
  <g fill="#C4C4C4" mask="url(#accessoriesCatEars-a)">
    <path d="M185.8 198.8c7.7-2.8 17.5-6 21.4-7.3l-25-8.9 3.6 16.2ZM179.5 173l-.6-10.8 18 6.2-17.4 4.6Z"/>
  </g>
  <path d="M269.5 136c-28.5 9.7-45.5 41.2-50.4 55.7-22.3-27.9-33.6-76.6-22-89.1 9.3-10 52.1 18 72.4 33.3Z" fill="#FEB3A4"/>
  <mask id="accessoriesCatEars-b" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="192" y="100" width="78" height="92">
    <path d="M269.5 136c-28.5 9.7-45.5 41.2-50.4 55.7-22.3-27.9-33.6-76.6-22-89.1 9.3-10 52.1 18 72.4 33.3Z" fill="#FEB3A4"/>
  </mask>
...
`,
  ...
  <mask id="accessoriesSailormoonCrown-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="125" y="158" width="297" height="95">
    <path d="M148.5 160.5c101.9-11.2 202.5 37.3 229 60 9.6-11.2 25.4-24.7 36.4-26 2.6 6 7 21 8.1 24.5-16 0-33.5 19.8-42.1 33.5-75.9-62.5-161.4-55-254.9-58a92.3 92.3 0 0 1 23.5-34Z" fill="#FFC00C"/>
  </mask>
  <g fill="#FFD45B" mask="url(#accessoriesSailormoonCrown-a)">
    <path d="m344 240.5 22.4-36.6-6.1-9.5-26.4 37.6 10 8.5ZM388.5 246.5l28.2-55.5 14 3.4L396 249l-7.6-2.5ZM327.3 225.8 353 191l-5-3-25 33.8 4.2 4ZM276 215l30.6-36.5-14.3-7-36 41L276 215Z"/>
  </g>
  <ellipse cx="378.2" cy="232.5" rx="8.8" ry="13.5" fill="#FF3C15"/>
  <mask id="accessoriesSailormoonCrown-b" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="369" y="219" width="18" height="27">
    <ellipse cx="378.2" cy="232.5" rx="8.8" ry="13.5" fill="#FF3C15"/>
  </mask>
  <g mask="url(#accessoriesSailormoonCrown-b)">
    <path d="M388.1 227a25.9 25.9 0 0 1-17 16.5c1.2 1.9 5 5.2 10.6 3.7 5.6-1.4 6.6-14 6.4-20.2Z" fill="#CB1414"/>
    <ellipse rx="3" ry="4.9" transform="matrix(.94302 .33275 -.30774 .95147 376 225.9)" fill="#FF7256"/>
  </g>
`,
  clownNose: (
    components: ComponentPickCollection,
  ...
  <mask id="accessoriesClownNose-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="359" y="300" width="57" height="57">
    <ellipse cx="387.5" cy="328.5" rx="28.4" ry="28.3" fill="#FF3C15"/>
  </mask>
  <g mask="url(#accessoriesClownNose-a)">
    <path d="M390 346.5a43.8 43.8 0 0 1-34-16.5c2.3 11.5 12.4 34.5 34 34.5s27-23 27-34.5a30.6 30.6 0 0 1-27 16.5Z" fill="#DD2400"/>
    <ellipse rx="9.2" ry="10.9" transform="matrix(.9746 .22399 -.44476 .89565 380.5 314.6)" fill="#FF7256"/>
  </g>
`,
  sleepMask: (
    components: ComponentPickCollection,
...
`,
  ...
  <g style="mix-blend-mode:screen" opacity=".2">
    <mask id="accessoriesSunglasses-a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="83" y="236" width="378" height="97">
      <path d="M258.6 290.6c3.6 17 11.2 32.8 25.4 37.4 31 10 70.1 2.3 76.1-4.4 2.2-2.4 5.4-11 8.2-21.5 16.9-9.6 31.4-4.2 36.2-.8a81.7 81.7 0 0 0 3.7 16.5c3 5.8 24.3 13 39 3.1 14.8-9.8 15.3-69 12.5-75.3-13-4.4-40.6-7.5-57.9 10.3-1.5 4.3-.7 17.9.8 31.2-8-2.7-18.9-3.8-31 .4 3-15.1 4-30.2-.1-35.5C358 238 283 231 259 241c-2.5 3.3-4.3 19.6-2.4 37.2-43.6-5.7-115.2-15-131-16.7-6-.6-16.8 1-25.9 6.4a33 33 0 0 0-12 12.2 33 33 0 0 0-3.7 20l12-1.3a21 21 0 0 1 2.1-12.9 21 21 0 0 1 7.8-7.7c6.8-4.1 15-5.1 18.5-4.8 16 1.8 91 11.5 134.2 17.2Z" fill="#595757" style="mix-blend-mode:multiply"/>
    </mask>
    <g mask="url(#accessoriesSunglasses-a)" fill="#fff">
      <path d="m303.8 223.6-65.7 91 18 13.7L340.7 221l-36.9 2.6ZM344.2 235.3l-77.3 96 3 22.4 95-111.4-20.7-7ZM474.8 231.6l-77.3 96 3 22.4 94.9-111.4-20.6-7Z"/>
    </g>
  </g>
`,
  faceMask: (
